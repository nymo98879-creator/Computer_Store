...
<div class="p-6 bg-gray-100 min-h-screen" x-data="{ showForm: false }">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Banner</h1>
            ...
            <tbody class="divide-y divide-gray-200">
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-3 text-center">
                        <button class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded-lg shadow">Edit</button>
                        <button class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded-lg shadow ml-2">Delete</button>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <div
        ...
        class="fixed inset-0 bg-gray-500/50 bg-opacity-60 flex items-center justify-center z-50"
        x-cloak
    >
        <!-- Modal Box -->
        <div
